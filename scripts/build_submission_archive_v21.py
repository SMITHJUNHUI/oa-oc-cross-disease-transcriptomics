#!/usr/bin/env python3
"""Build the curated V2.1 submission package without raw matrices or caches."""
...
def main() -> None:
    ...
    deliverables = {
        "OC_OA_manuscript_revision_v21_with_figures.docx": "manuscript/OC_OA_manuscript_revision_v21_with_figures.docx",
        "OC_OA_manuscript_revision_v21_with_figures.pdf": "manuscript/OC_OA_manuscript_revision_v21_with_figures.pdf",
        "OC_OA_manuscript_revision_v21.docx": "manuscript/OC_OA_manuscript_revision_v21.docx",
        "OC_OA_manuscript_revision_v21.pdf": "manuscript/OC_OA_manuscript_revision_v21.pdf",
        "OC_OA_manuscript_revision_v21.md": "manuscript/OC_OA_manuscript_revision_v21.md",
        "OC_OA_revision_v21_response_matrix.md": "manuscript/OC_OA_revision_v21_response_matrix.md",
        "OC_OA_submission_audit_report_v21.md": "manuscript/OC_OA_submission_audit_report_v21.md",
    }
    ...
    add_file(
        files,
        project / "manuscript" / "OC_OA_manuscript_revision_v21.md",
        "rebuild/manuscript/OC_OA_manuscript_revision_v21.md",
    )

    required = {
        "manuscript/OC_OA_manuscript_revision_v21_with_figures.docx",
        "manuscript/OC_OA_manuscript_revision_v21_with_figures.pdf",
        ...
        "supplementary_tables/Table_S15b_TCGA_candidate_context_correlations.csv",
        "manifests/claim_evidence_registry_v21.csv",
        "rebuild/run_submission_v21.ps1",
        "rebuild/scripts/audit_submission_v21.py",
    }
    missing = sorted(required.difference(files))
    if missing:
        raise SystemExit(f"Missing required V2.1 entries: {missing}")
    ...
    with ZipFile(output) as archive:
        ...
        if not required.issubset(names):
            raise SystemExit("V2.1 archive verification failed after writing.")
